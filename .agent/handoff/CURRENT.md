...
**Estado del PR:** abierto hacia `feat/vertical-slice`, no fusionado. El merge lo decide Hugo. Ver la sección "Referencias" al final de este documento para la URL una vez creado, o `gh pr list` en el repo.
